...
export default function Cart() {
  ...
  return (
    <div className="pt-[100px] pb-20 min-h-screen relative z-10 max-w-[1320px] mx-auto px-6">
      <h1 className="text-3xl font-bold text-white mb-8 border-b border-white/10 pb-4">Shopping <span className="bg-[linear-gradient(135deg,#ffffff,#b3ffff,#ffffff)] text-transparent bg-clip-text" style={{ filter: 'drop-shadow(0px 4px 20px rgba(0,0,0,0.9))' }}>Cart</span></h1>
