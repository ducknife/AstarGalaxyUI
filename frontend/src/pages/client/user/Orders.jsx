  ...
  return (
    <div>
      ...
      <div className="flex gap-6 mb-8 border-b border-white/5 pb-2">
        ...
        <button className="text-white/90 hover:text-white transition-colors pb-2">To Pay</button>
        <button className="text-white/90 hover:text-white transition-colors pb-2">To Ship</button>
        <button className="text-white/90 hover:text-white transition-colors pb-2">Completed</button>
        <button className="text-white/90 hover:text-white transition-colors pb-2">Cancelled</button>
      </div>
